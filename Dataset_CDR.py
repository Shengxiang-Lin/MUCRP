...
class Dataset(object):
    ...
    def load_data(self, dataset):
        print('loading data...{}')
        peo2movie = pickle.load(open(os.path.join('data', dataset,'peo2movie_id.pkl'), 'rb'))
        peo2book = pickle.load(open(os.path.join('data', dataset,'peo2book_id.pkl'), 'rb'))
        movie2peo = pickle.load(open(os.path.join('data', dataset,'movie2peo_id.pkl'), 'rb'))
        book2peo = pickle.load(open(os.path.join('data', dataset,'book2peo_id.pkl'), 'rb'))
    ...
    def get_test_data(self, dataset):
        if not os.path.exists(os.path.join(os.getcwd(), 'data', dataset, 'movie_vali.pkl')) or \
                not os.path.exists(os.path.join(os.getcwd(), 'data', dataset, 'movie_test.pkl')):
            movie_vali = {}
            movie_test = {}
            book_vali = {}
            book_test = {}
            ...
            pickle.dump(movie_vali, open(os.path.join('data', dataset, 'movie_vali.pkl'), 'wb'))
            pickle.dump(book_vali, open(os.path.join('data', dataset, 'book_vali.pkl'), 'wb'))

            pickle.dump(movie_test, open(os.path.join('data', dataset, 'movie_test.pkl'), 'wb'))
            pickle.dump(book_test, open(os.path.join('data', dataset, 'book_test.pkl'), 'wb'))

            pickle.dump(movie_nega, open(os.path.join('data', dataset, 'movie_nega.pkl'), 'wb'))
            pickle.dump(book_nega, open(os.path.join('data', dataset, 'book_nega.pkl'), 'wb'))

        else:
            movie_vali = pickle.load(open(os.path.join('data', dataset, 'movie_vali.pkl'), 'rb'))
            book_vali = pickle.load(open(os.path.join('data', dataset, 'book_vali.pkl'), 'rb'))

            movie_test = pickle.load(open(os.path.join('data', dataset, 'movie_test.pkl'), 'rb'))
            book_test = pickle.load(open(os.path.join('data', dataset, 'book_test.pkl'), 'rb'))

            movie_nega = pickle.load(open(os.path.join('data', dataset, 'movie_nega.pkl'), 'rb'))
            book_nega = pickle.load(open(os.path.join('data', dataset, 'book_nega.pkl'), 'rb'))
